...
tweaks_relay_stream_flush_size_default = tweaks.relay_stream_flush_size
...
function fill()
    ...
    fiber.create(function()
        ...
        tweaks.relay_stream_flush_size = 1
...
tweaks.relay_stream_flush_size = tweaks_relay_stream_flush_size_default
